...
CSS = """
window.dp-theme-sport .dp-main-nav,
window.dp-theme-sport .dp-main-nav scrolledwindow,
window.dp-theme-sport .dp-main-nav scrolledwindow > viewport,
...
def _draw_impl(cr: Any, width: int, height: int, data: Any, dark: bool) -> None:
    ...
    if width >= height:
        _draw_sport_landscape(cr, width, height - strip_h, data, pal)
    else:
        _draw_sport_portrait(cr, width, height - strip_h, data, pal)
