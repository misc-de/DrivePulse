...
def load_settings() -> dict[str, Any]:
    ...
    return {
        ...
        "nav_position": data.get("nav_position", "auto") if data.get("nav_position") in {"auto", "top", "bottom"} else "auto",
        ...
        json.dumps(
            {
                ...
                "nav_position": settings.get("nav_position", "auto") if settings.get("nav_position") in {"auto", "top", "bottom"} else "auto",
