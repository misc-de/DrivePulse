...
from drivepulse_app.cars.share_actions import CarsShareActionsMixin
...
from drivepulse_app.cars.vin_flow import CarsVinFlowMixin
...
_DP_NEW_DOT_CSS = (
    ...
    b".dp-value-chevron { background-color: transparent; }\n"
)
