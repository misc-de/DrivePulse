...
class CarsLayoutMixin:
    ...
    def _build_detail_page(self) -> None:
        ...
        self._list_select_share_btn = Gtk.Button(icon_name="share-alt-symbolic")
        self._list_select_share_btn.add_css_class("flat")
        self._list_select_share_btn.set_visible(False)
        self._list_select_share_btn.connect("clicked", lambda _b: self._on_share_btn_clicked())

        self._list_select_trash_btn = Gtk.Button(icon_name="user-trash-symbolic")
        self._list_select_trash_btn.add_css_class("flat")
        self._list_select_trash_btn.set_visible(False)
        self._list_select_trash_btn.connect("clicked", lambda _b: self._on_list_select_trash_clicked())
        ...
        head.append(self._list_select_share_btn)
