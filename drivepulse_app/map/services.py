...
# Re-exports from extracted submodules so existing
...
# _log_valhalla_trace_failure, ROUTING_BACKENDS, _VALHALLA_*, _VALHALLA_MANEUVER:
# moved to drivepulse_app/map/_routing.py
...
# geocode: moved to drivepulse_app/map/_geocoding.py


# osrm_route, compute_route, _flatten_route_steps:
# moved to drivepulse_app/map/_routing.py


# mock_speed_kmh, _parse_maxspeed, fetch_overpass_speed_zones:
# moved to drivepulse_app/map/_speed_zones.py
# _pt_seg_dist2_approx, _decode_polyline: moved to drivepulse_app/map/_geometry.py


# valhalla_route, _valhalla_error_summary, _trace_shape, _trace_bodies:
# moved to drivepulse_app/map/_routing.py
# _subsample_coords: moved to drivepulse_app/map/_geometry.py


# _remap_speed_to_route: moved to drivepulse_app/map/_speed_zones.py
...
# osrm_match_route: moved to drivepulse_app/map/_routing.py


# valhalla_trace_route, _flatten_valhalla_maneuvers:
# moved to drivepulse_app/map/_routing.py


# resolve_route_points: moved to drivepulse_app/map/_geocoding.py


# format_duration, format_distance, poi_category, maneuver_icon,
# maneuver_text_key: moved to drivepulse_app/map/_format.py


# snap_to_route: moved to drivepulse_app/map/_geometry.py
# (along with haversine, bearing, zoom_for_bbox); re-exported at the top
# of this file.
